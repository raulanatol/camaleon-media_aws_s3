module Plugins::MediaAwsS3::MainHelper
  ...
  def media_aws_s3_front_before_load
    append_asset_libraries({'plugin_media_aws_s3' => {js: [plugin_asset_path('media_aws_s3', 'js/main')]}})
  end

  def media_aws_s3_admin_before_load
    append_asset_libraries({'plugin_media_aws_s3' => {js: [plugin_asset_path('media_aws_s3', 'js/main')]}})
  end
end
